...
<head>
    ...
    <script src="http://localhost/practica-codeig/application/css/select_provincies.js"></script>
    ...
    <div class="container">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <?php } ?>
                <li><a href="<?php echo site_url("contNotificacions/index"); ?>">Notificacions</a></li>
            </ul>
        </div>
                ...
                <li class="">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <a href="<?php echo(site_url("ContPerfil/index")); ?>" class="btn btn-default btn-flat">Modificar
                                Perfil</a>
